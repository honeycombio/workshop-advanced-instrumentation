...
public class YearController {
    ...
    // add a logger
    private static final Logger logger = Logger.getLogger(YearController.class.getName());
    ...
    public Map<String, Object> year() {
        ...
        logger.fine("returning response, " + response.toString());
    ...
    public void doSomeWork() {
        ...
        logger.fine("starting doSomeWork");
