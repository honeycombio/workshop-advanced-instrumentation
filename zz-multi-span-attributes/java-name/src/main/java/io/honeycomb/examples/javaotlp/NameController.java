...
public class NameController {
    ...
    private static final Map<Integer, List<String>> NAMES_BY_YEAR = Map.of(2015, Arrays.asList("sophia", "jackson", "emma", "aiden", "olivia", "liam", "ava", "lucas", "mia", "noah"), 2016, Arrays.asList("sophia", "jackson", "emma", "aiden", "olivia", "lucas", "ava", "liam", "mia", "noah"), 2017, Arrays.asList("sophia", "jackson", "olivia", "liam", "emma", "noah", "ava", "aiden", "isabella", "lucas"), 2018, Arrays.asList("sophia", "jackson", "olivia", "liam", "emma", "noah", "ava", "aiden", "isabella", "caden"), 2019, Arrays.asList("sophia", "liam", "olivia", "jackson", "emma", "noah", "ava", "aiden", "aria", "grayson"), 2020, Arrays.asList("olivia", "noah", "emma", "liam", "ava", "elijah", "isabella", "oliver", "sophia", "lucas"));
